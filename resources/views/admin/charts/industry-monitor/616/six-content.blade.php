...
<h1>固定资产投资总额:<span id="gt"></span></h1>
<div class="box">
    <div class="row">
        <div class="col-lg-3">
                            ...
                            <div class="col-lg-12">
                                <dl class="dl-horizontal">
                                    ...
                                    <dd>
                                        ...
                                        <small>Project completed in <strong>60%</strong>. Remaining close the project,
                                    ...
                                    <div class="panel-heading">
                                        <div class="panel-options">
                                            <ul class="nav nav-tabs">
                                                ...
                                                <li class=""><a href="#tab-2" data-toggle="tab" aria-expanded="false">Last
                                                        activity</a></li>
                                            </ul>
                                        </div>
                                    </div>
