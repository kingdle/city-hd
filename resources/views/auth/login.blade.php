                ...
                <div class="col-md-12 text-center porctlist">
                    <div class="conlistpage">
                        <ul class="conlist1">
                            <li>
                                <p>
                                    <a href=""><img src="{{ asset('uploads/icon/important.png') }}">重点关注</a>
                                </p>
                            </li>
                            <li>
                                <p>
                                    <a href=""><img src="{{ asset('uploads/icon/special.png') }}">专题监测</a>
                                </p>
                            </li>
                            <li>
                                <p>
                                    <a href=""><img src="{{ asset('uploads/icon/search.png') }}">快速查询</a>
                                </p>
                            </li>
                            <li>
                                <p>
                                    <a href=""><img src="{{ asset('uploads/icon/area.png') }}">区域经济</a>
                                </p>
                            </li>
                            <li>
                                <p>
                                    <a href=""><img src="{{ asset('uploads/icon/project.png') }}">投资项目监测</a>
                                </p>
                            </li>
                            <li>
                                <p>
                                    <a href=""><img src="{{ asset('uploads/icon/forum.png') }}">街道互动</a>
                                </p>
                            </li>
                            <li>
                                <p>
                                    <a href=""><img src="{{ asset('uploads/icon/base.png') }}">资料信息库</a>
                                </p>
                            </li>
                            <li>
                                <p>
                                    <a href=""><img src="{{ asset('uploads/icon/my.png') }}">我的数据</a>
                                </p>
                            </li>
                        </ul>
                    </div>
